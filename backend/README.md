...
## Project Structure
    ...
    ├── quilting_for_commun_40211  # Django project configurations
...
1. Clone this repo and `cd quilting_for_commun_40211`
...
2. Clone this repo and `cd quilting_for_commun_40211`
